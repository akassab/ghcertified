---
question: "W GitHub Actions, jeśli zdefiniujesz zarówno filtr `branches`, jak i `paths`, jaki będzie efekt działania workflow?"
...
- [ ] workflow nie uruchomi się, gdy oba warunki `branches` i `paths` zostaną spełnione
