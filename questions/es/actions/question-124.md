...
- <input type="checkbox" disabled> 4 trabajos
- <input type="checkbox" disabled> 5 trabajos
- <input type="checkbox" disabled> 6 trabajos
- <input type="checkbox" disabled> 7 trabajos
- <input type="checkbox" disabled> No se ejecutarán trabajos porque la sintaxis es inválida.
