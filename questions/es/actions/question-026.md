---
question: "Un flujo de trabajo reutilizable llamado `build` crea artefactos de archivos zip. ¿Cómo se pasa la ubicación del archivo zip al flujo de trabajo que llama al flujo de trabajo `build`?"
