...
- <input type="checkbox" disabled> Se ejecutará con el código del `commit A`
- <input type="checkbox" disabled> Se ejecutará con el código del `commit B`
- <input type="checkbox" disabled> No puedes volver a ejecutar flujos de trabajo en GitHub Actions. Tienes que activar un nuevo flujo de trabajo que se ejecutará con los últimos cambios.
- <input type="checkbox" disabled> Activará dos flujos de trabajo, uno con el código del `commit A` y otro con el código del `commit B`.
