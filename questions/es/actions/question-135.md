...
- <input type="checkbox" disabled> Los repositorios bifurcados no heredan secretos del repositorio original  
- <input type="checkbox" disabled> Al heredar el secreto del repositorio original, ocurrió un error durante la bifurcación que resultó en un secreto malformado o inválido
- <input type="checkbox" disabled> El secreto heredado tenía un tamaño mayor a 48 KB
- <input type="checkbox" disabled> Los repositorios bifurcados solo heredan secretos del repositorio, por lo que el secreto usado en el workflow debe haber sido un secreto organizacional o de entorno.
