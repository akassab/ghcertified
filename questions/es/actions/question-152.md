...
- <input type="checkbox" disabled> comienza vacía y debe llenarse para guardar herramientas entre ejecuciones
- <input type="checkbox" disabled> comienza igual que los runners alojados por GitHub, es decir, pre-poblada con ciertas herramientas
- <input type="checkbox" disabled> comienza con las mismas herramientas que los runners alojados por GitHub, así como una selección de herramientas personalizadas para mejorar la gestión de runners autohospedados
- <input type="checkbox" disabled> no puede ser poblada
