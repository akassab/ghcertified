...
- <input type="checkbox" disabled> GitHub Connectを使用する
- <input type="checkbox" disabled> GitHub Enterprise ServerはデフォルトですべてのGitHub.com Actionsにアクセスできる
- <input type="checkbox" disabled> actions-syncツールを使用する
- <input type="checkbox" disabled> GitHub Enterprise Server (GHES)は、そのオンプレミスの性質とインターネットアクセスがないため、GitHub.com Actionsを使用できない
