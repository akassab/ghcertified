...
- <input type="checkbox" disabled> OIDC を使用する
- <input type="checkbox" disabled> Vault を使用する
- <input type="checkbox" disabled> アクセスキーを `secrets` に保存する
- <input type="checkbox" disabled> アクセスキーを `variables` に保存する
