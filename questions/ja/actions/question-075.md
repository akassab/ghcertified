...
- <input type="checkbox" disabled> いいえ
- <input type="checkbox" disabled> はい
- <input type="checkbox" disabled> 並列で実行される場合のみ
- <input type="checkbox" disabled> 同じ `runs-on` ラベルを使用する場合のみ
