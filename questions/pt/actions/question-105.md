---
question: "Qual das seguintes afirmações descreve com precisão o comportamento dos jobs do workflow que referenciam as regras de proteção de um ambiente?"
...
- [ ] os jobs do workflow falharão se as regras de proteção estiverem configuradas
