...
- <input type="checkbox" disabled> Incluindo qualquer uma das seguintes palavras-chave na mensagem de commit ou no título do pull-request
```yaml
[skip ci]
[ci skip]
[no ci]
...
- <input type="checkbox" disabled> Forneça `SKIP_WORKFLOW` na mensagem de commit
- <input type="checkbox" disabled> O workflow acima será executado em todo evento de push ou pull request em todos os casos
