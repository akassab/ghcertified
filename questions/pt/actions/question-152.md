...
- <input type="checkbox" disabled> começa vazio e deve ser preenchido para salvar ferramentas entre as execuções
- <input type="checkbox" disabled> começa semelhante aos runners hospedados pelo GitHub, pois vem pré-preenchido com certas ferramentas
- <input type="checkbox" disabled> começa com as mesmas ferramentas que os runners hospedados pelo GitHub, além de uma seleção personalizada para melhorar o gerenciamento de runners auto-hospedados
- <input type="checkbox" disabled> não pode ser preenchido
