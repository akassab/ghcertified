...
```
- <input type="checkbox" disabled> o job `production-deploy` será marcado como ignorado
- <input type="checkbox" disabled> o job `production-deploy` apresentará erro
- <input type="checkbox" disabled> o job `production-deploy` executará três etapas
- <input type="checkbox" disabled> o job `production-deploy` será executado se o `node-version` for `14`
