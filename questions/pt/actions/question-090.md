...
- <input type="checkbox" disabled> 30 minutos  
- <input type="checkbox" disabled> 60 minutos  
- <input type="checkbox" disabled> 120 minutos  
- <input type="checkbox" disabled> 360 minutos  
